...
{
    internal class GameConfigurationTeamNumbersButtonsCreateCommon
    {

        public static GameObject[,,] CreateCommonButtonForTeamNumbersFourRows(GameObject prefabCubePlay, Material[] prefabCubePlayDefaultColour, bool isGame2D, string tagNameDictionary, string buttonText)
        {
            GameObject[,,] button;
        ...
        public static GameObject[,,] CreateCommonButtonForTeamNumbersNumber(GameObject prefabCubePlay, Material[] prefabCubePlayDefaultColour, bool isGame2D, string tagNameDictionary, string buttonText)
        {
            GameObject[,,] button;
