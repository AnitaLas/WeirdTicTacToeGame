...
namespace Assets.Scripts
{
    internal class GameChangeText
    {
        ...
        public static void SetUpPlayerSymbolForCubePlay(GameObject[,,] gameBoard, string cubePlayName, string[] playersSymbols, int currentPlayerNumber)
        {
            //int currentPlayerNumber = currentPlayer[playersNumber];
            string symbol = GameChangeMethods.GetPlayerSymbol(playersSymbols, currentPlayerNumber);
