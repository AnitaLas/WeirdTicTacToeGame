...
namespace Assets.Scripts
{
    internal class PlayGameSwitchPlayersSymbolsButtonsCreate
    {
        ...
        public static List<GameObject[,,]> GameSwitchPlayersSymbolsButtonsTopCreate(GameObject prefabCubePlay, Material[] prefabCubePlayButtonsDefaultColour, Material[] prefabCubePlayButtonsNumberColour, bool isGame2D)
        {
            ...
            GameObject[,,] buttonTopPlayersSymbols = PlayGameChangePlayersSymbolsButtonsCreateTopPlayersSymbols(prefabCubePlay, prefabCubePlayButtonsDefaultColour, isGame2D);
            GameObject[,,] buttonTopChange = PlayGameChangePlayersSymbolsButtonCreateTopChange(prefabCubePlay, prefabCubePlayButtonsNumberColour, isGame2D);
        ...
        public static List<GameObject[,,]> GameChangePlayersSymbolsButtonsCreate(GameObject prefabCubePlay, Material[] prefabCubePlayButtonsDefaultColour, Material[] prefabCubePlayButtonsNumberColour, bool isGame2D, Material[] prefabCubePlayButtonsBackColour, ArrayList newDataForPlayersSymbolsSwitch)
        {
